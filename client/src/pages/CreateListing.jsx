...
setFormData({
  ...
  return (
    <main  className='p-3 max-w-4xl mx-auto'>
        ...
        <form action="" className='flex gap-10 flex-col sm:flex-row'>
         ...
         <div className='flex flex-col flex-1 gap-4'>
           ...
           <div className=' flex gap-4 ' >
            <input  onChange={(e)=>setFiles(e.target.files)}className=' w-full p-3 border border-gray-300' type="file" id='images' accept='image/*' multiple />
            <button disabled={uploading} type='button' onClick={
               (e)=> handleImageSubmit(e)} className='  rounded-lg p-3 text-green-700 border border-green-700 hover:shadow-lg  disabled:opacity-80'>{
       ...
       <img className='w-40 h-40 object-cover rounded-lg'
         ...
         <button className='p-3 bg-slate-100 text-white uppercase  rounded-ld  hover:opacity-95 disabled:opacity-80'>Create Listing</button>
